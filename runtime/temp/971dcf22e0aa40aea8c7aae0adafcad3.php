<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:71:"D:\phpstudy\WWW\material\public/../application/admin\view\cate\lst.html";i:1534204646;s:63:"D:\phpstudy\WWW\material\application\admin\view\public\top.html";i:1533542488;s:64:"D:\phpstudy\WWW\material\application\admin\view\public\left.html";i:1534044256;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
...
<button type="button" tooltip="添加用户" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = 'add'"> <i class="fa fa-plus"></i> Add
</button>
<div class="row">
        ...
        <div class="widget">
            <div class="widget-body">
                <div class="flip-scroll">
                    ...
                    <div><input class="btn btn-primary btn-sm shiny" style="margin-left:174px; margin-top:10px;" type="submit" value="排序" ></div>
                    </form>
                </div>

<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:74:"D:\phpstudy\WWW\material\public/../application/admin\view\article\lst.html";i:1534407408;s:63:"D:\phpstudy\WWW\material\application\admin\view\public\top.html";i:1533542488;s:64:"D:\phpstudy\WWW\material\application\admin\view\public\left.html";i:1534044256;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        <li><a href="#">系统</a></li>             
                         ...
                         <li>
                            <form method="post" style="float: right;padding-left: 15px;">
                               <div class="search">
                                    <input class="searchinput" type="text" name="search">
                                    <input type="submit"  class="ssss">
                                    <td align="left" >
                                         <label style="margin-right:15px;margin-left: 15px;">
                                        <input name="style" value="0" type="radio">
                                        <span class="text">栏目</span>
                                        </label>
                                        <label style="margin-right:15px;">
                                        <input checked="checked" name="style" value="1" type="radio">
                                        <span class="text">文章</span>
                                        </label>
                                   </td>
                                   <td align="left">
                                                                                    <label>
                                                <input name="code" class="colored-success" value="是" type="checkbox">
